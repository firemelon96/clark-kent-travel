...
type Props = z.input<typeof FastCraftFormSchema>;

export const FastCraftEmailTemplate = ({
  name,
  email,
  age,
  contact,
          ...
          <Container className="mx-auto my-2 max-w-[500px]">
            ...
            <Section className="border border-solid border-[#eaeaea] p-[20px]">
              ...
              <Text className="text-[14px]leading-4 tracking-widest text-black">
                ...
                {title} | {vehicleType} | {type} | {availability} | x
                {participantCount} Person
              </Text>
              <Text className="text-[14px] leading-4 tracking-widest text-black">
...
export default FastCraftEmailTemplate;
