      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span>{format(eachParams.date, "EEEE, LLL dd, yyyy")}</span>
          </div>
          <div className="flex justify-between text-sm">
            <p className="flex items-center gap-2 text-slate-500">
              <Clock1 className="size-3" /> Time
            </p>
            <span>{eachParams.time}</span>
          </div>
          <div className="flex justify-between text-sm">
            <p className="flex items-center gap-2 text-slate-500">
          ...
          <a
            href={eachParams.location}
            target="_blank"
            className="flex items-center gap-2 text-xs text-slate-500 underline"
          >
            <PinIcon className="size-3" /> Meet up location
          </a>
          <Separator />
        </CardContent>
