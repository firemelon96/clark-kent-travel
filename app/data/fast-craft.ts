export const fastCrafts = [
  {
    id: "jomalia-fastcraft-pps-to-coron",
    service_name: "Elnido to Coron Jomalia Fast Craft ",
    vehicle_type: "cruise",
    type: "fast craft",
    capacity: 15,
    price_per_trip: 2800,
    ...
    availability: "12:30 AM Daily",
    images: [
      "https://cdn.palawanwebsolutions.com/clarkkent/logistics/jomalia.avif",
      "https://cdn.palawanwebsolutions.com/clarkkent/logistics/jomalia-sched.jpeg",
    ],
  },
  {
    id: "jomalia-fastcraft-coron-to-pps",
    service_name: "Coron to Elnido Jomalia Fast Craft ",
    vehicle_type: "cruise",
    type: "fast craft",
    capacity: 15,
    price_per_trip: 2800,
