...
const travelTimes = ["6:00 AM", "12: 00 PM", "5:00PM"];

export const BookOptionTransfer = ({
  id,
  pricing,
  title,
  pickUpLocation,
  ...
  const form = useForm<z.infer<typeof transferOptionSchema>>({
    ...
    defaultValues: {
      ...
      totalPrice: 0,
      type: priceType[0],
      time: travelTimes ? travelTimes[0] : "",
      location: shareLink || mapLink,
    },
  });
  ...
  const onSubmit = (values: z.infer<typeof transferOptionSchema>) => {
    const { participants, totalPrice, date, type, time } = values;
      ...
      >
                ...
                <Popover open={openDate} onOpenChange={setOpenDate}>
                  <PopoverTrigger asChild>
                    <FormControl className="">
                      ...
                      >
                        {field.value ? (
                          <>{format(field.value, "EEEE, LLL. dd, y")}</>
                        ) : (
        ...
        {date && (
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="">
                <FormLabel>Select travel time</FormLabel>
                <FormControl>
